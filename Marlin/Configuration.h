...
//============================= SCARA Printer ===============================
//===========================================================================
// For a SCARA printer start with the configuration files intemp
...
#define STRING_CONFIG_H_AUTHOR "(xC0000005, Lerdge-X Config)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 93, 93, 1097, 97 }
...
//
// Lerdge-S/X/K 320x240 color display
//
#define LERDGE_TFT
